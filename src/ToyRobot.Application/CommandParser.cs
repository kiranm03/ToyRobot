...
public class CommandParser
{
    public ParsedCommand Parse(string input)
    {
        ...
        if (!Enum.TryParse<CommandType>(commandText, ignoreCase: true, out var commandType))
...
public readonly record struct ParsedCommand(CommandType CommandType, string RawInput = "")
{
